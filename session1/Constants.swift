...
let ENEMY_GREEN_TEXTURE=[
    ENEMY_GREEN1,
    ENEMY_GREEN2,
    ENEMY_GREEN3
]
let ENEMY_YELLOW1 = SKTexture(imageNamed: "enemy_plane_yellow_1")
let ENEMY_YELLOW2 = SKTexture(imageNamed: "enemy_plane_yellow_2")
let ENEMY_YELLOW3 = SKTexture(imageNamed: "enemy_plane_yellow_3")
let ENEMY_YELLOW=[ENEMY_YELLOW1 ,ENEMY_YELLOW2 ,ENEMY_YELLOW3]
